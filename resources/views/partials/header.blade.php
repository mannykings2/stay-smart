...
<header class="top-header">
    <nav class="navbar navbar-expand gap-3 align-items-center">
        ...
        <form class="searchbar" action="{{ route('properties.index') }}" method="GET">
                ...
                @auth
                    <li class="nav-item dropdown dropdown-user-setting">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            @unless(auth()->user()->hasRole('Cleaner'))
                                <li>
                                    <a class="dropdown-item" href="{{route('properties.index')}}">
                                        <div class="d-flex align-items-center">
                                            <div class=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                    fill="currentColor" class="bi bi-suitcase" viewBox="0 0 16 16">
                                                    <path
                            ...
                            @unless(auth()->user()->hasRole('Cleaner'))
                                <li>
                                    <a class="dropdown-item" href="{{route('properties.checkIn')}}">
                                        <div class="d-flex align-items-center">
