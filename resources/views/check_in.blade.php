                    ...
                    <div class="apartment-contactbox">
                        <div class="row justify-content-center mt-4">
                            ...
                            <div class="align-items-center">
                                <a href="#" data-id="{{$booking->id}}" class="header-btn11 search border-0 checkIn">Check In <i class="fa-solid fa-sign-in"></i></a>
                            </div> @else @endif
                        </div>
                    </div>
                </div>
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                if (response.status === "success") {
                                    Swal.fire("Done!", "You have been checked in!", "success");
                                } else {
