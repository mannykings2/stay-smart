...
@section('content')
    <main class="page-content">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 mt-5">
                    <div class="d-flex justify-content-between mb-4">
                        <h2 class="text-center">Driver Services</h2>
                    ...
                    <div class="card rounded-4">
                        <div class="card-body">
                                                    ...
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            ...
                                                            <button type="button" class="btn btn-sm btn-outline-danger rounded-3"
                                                                onclick="submitDeleteService('{{ route('driver.service.destroy', $service->id) }}')">
                            ...
                            @else
                                <p class="text-center mb-0 p-3">There are no driver services available</p>
                            @endif
                        </div>
                    </div>
                </div>
        ...
        @include('modals.add-driver-service')
        @include('modals.edit-driver-service')
