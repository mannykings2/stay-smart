                ...
                <div class="card rounded-4 p-4">
                    <form action="{{ route('drivers.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        {{-- <div class="mb-3">
                            ...
                            <input type="text" name="specialty" class="form-control" placeholder="E.g. City Driving, Highway, Airport Transfers">
                        </div> --}}
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="vehicle_details" class="form-control" placeholder="E.g. Toyota Camry 2020 - White" required>
                        </div>
